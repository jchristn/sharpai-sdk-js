...
To use the link you just defined in your project, switch to the directory you want to use your SharpAI from, and run:

```shell
npm link sharpai-sdk
```
...
```javascript
import sdk from 'sharpai-sdk';
//or
var sdk = require('sharpai-sdk');
```
...
```javascript
var { SharpAISdk } = require('sharpai-sdk');

var api = new SharpAISdk(
